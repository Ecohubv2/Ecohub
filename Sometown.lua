...
-- Hook into existing farm loop
-- This overrides selling logic so it sells only when all selected farms are full

task.spawn(function()
    while task.wait(1) do
        if Env.AutoFarm and Env.SelectedFarmTargets and #Env.SelectedFarmTargets > 0 then
            local currentJobData = getCurrentFarmData()
