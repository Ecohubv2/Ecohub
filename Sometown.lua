...
local function CreateToggle()
    ...
    local old = pgui:FindFirstChild("NONAME")
...
Window:SelectTab(1)
Library:Notify({ Title = "NO NAME", Content = "Loaded Fully", Duration = 5 })
